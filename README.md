...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cat
```

A live public deployment of this template is available at [https://cat.templates.workers.dev](https://cat.templates.workers.dev)
